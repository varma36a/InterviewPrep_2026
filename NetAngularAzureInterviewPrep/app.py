...
def render_home() -> None:
    ...
    st.markdown(
        '<p class="blog-hero-lead">Phase-wise interview Q&A with <strong>1150+ topics</strong> '
        "(448 Love Babbar DSA with TC/SC, 50 React, 50 AWS, 40 HLD, 40 CS Fundamentals), "
