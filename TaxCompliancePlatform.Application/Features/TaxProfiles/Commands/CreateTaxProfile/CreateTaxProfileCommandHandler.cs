...
public sealed class CreateTaxProfileCommandHandler(ICurrentTenantProvider currentTenantProvider, IRepository<TaxProfile> taxProfileRepository, IUnitOfWork unitOfWork)
